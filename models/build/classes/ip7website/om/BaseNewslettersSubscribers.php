...
/**
 * Base class that represents a row from the 'newsletters_subscribers' table.
 *
 *
 *
 * @package    propel.generator.ip7website.om
 */
abstract class BaseNewslettersSubscribers extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'NewslettersSubscribersPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        NewslettersSubscribersPeer
     */
     ...
     * @return NewslettersSubscribers The current object (for fluent API support)
     */
    public function setSubscriberId($v)
    {
        ...
        if ($this->subscriber_id !== $v) {
            ...
            $this->modifiedColumns[] = NewslettersSubscribersPeer::SUBSCRIBER_ID;
        }
    ...
    public function setNewsletterId($v)
    {
        ...
        if ($this->newsletter_id !== $v) {
            ...
            $this->modifiedColumns[] = NewslettersSubscribersPeer::NEWSLETTER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = NewslettersSubscribersPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating NewslettersSubscribers object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = NewslettersSubscribersPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = NewslettersSubscribersQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                NewslettersSubscribersPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NewslettersSubscribersPeer::SUBSCRIBER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`SUBSCRIBER_ID`';
        }
        if ($this->isColumnModified(NewslettersSubscribersPeer::NEWSLETTER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`NEWSLETTER_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `newsletters_subscribers` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = NewslettersSubscribersPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = NewslettersSubscribersPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['NewslettersSubscribers'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['NewslettersSubscribers'][serialize($this->getPrimaryKey())] = true;
        $keys = NewslettersSubscribersPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NewslettersSubscribersPeer::SUBSCRIBER_ID)) $criteria->add(NewslettersSubscribersPeer::SUBSCRIBER_ID, $this->subscriber_id);
        if ($this->isColumnModified(NewslettersSubscribersPeer::NEWSLETTER_ID)) $criteria->add(NewslettersSubscribersPeer::NEWSLETTER_ID, $this->newsletter_id);
    ...
    {
        $criteria = new Criteria(NewslettersSubscribersPeer::DATABASE_NAME);
        $criteria->add(NewslettersSubscribersPeer::SUBSCRIBER_ID, $this->subscriber_id);
        $criteria->add(NewslettersSubscribersPeer::NEWSLETTER_ID, $this->newsletter_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getSubscriberId()) && (null === $this->getNewsletterId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of NewslettersSubscribers (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return NewslettersSubscribers Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return NewslettersSubscribersPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new NewslettersSubscribersPeer();
        }
    ...
    public function setSubscriber(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addNewslettersSubscribers($this);
        }
    ...
    public function getSubscriber(PropelPDO $con = null)
    {
        if ($this->aSubscriber === null && ($this->subscriber_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSubscriber->addNewslettersSubscriberss($this);
             */
        }
    ...
    public function getNewsletter(PropelPDO $con = null)
    {
        if ($this->aNewsletter === null && ($this->newsletter_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aNewsletter->addNewslettersSubscriberss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(NewslettersSubscribersPeer::DEFAULT_STRING_FORMAT);
    }
