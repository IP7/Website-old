...
abstract class BaseTransactionPeer {
    ...
    const VALIDATED = 'transactions.VALIDATED';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TransactionPeer::VALIDATED);
        } else {
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($obj->isNew() || $obj->isColumnModified(TransactionPeer::DESCRIPTION))
            $columns[TransactionPeer::DESCRIPTION] = $obj->getDescription();
