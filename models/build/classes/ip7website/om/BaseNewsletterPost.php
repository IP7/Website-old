...
abstract class BaseNewsletterPost extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'NewsletterPostPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        NewsletterPostPeer
     */
    ...
    protected function loadText(PropelPDO $con = null)
    {
        ...
        $c->addSelectColumn(NewsletterPostPeer::TEXT);
        try {
            $stmt = NewsletterPostPeer::doSelectStmt($c, $con);
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = NewsletterPostPeer::ID;
        }
    ...
    public function setNewsletterId($v)
    {
        ...
        if ($this->newsletter_id !== $v) {
            ...
            $this->modifiedColumns[] = NewsletterPostPeer::NEWSLETTER_ID;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = NewsletterPostPeer::DATE;
            }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[] = NewsletterPostPeer::TEXT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = NewsletterPostPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating NewsletterPost object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = NewsletterPostPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
        $row = $stmt->fetch(PDO::FETCH_NUM);
        $stmt->closeCursor();
        if (!$row) {
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = NewsletterPostQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                NewsletterPostPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NewsletterPostPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(NewsletterPostPeer::NEWSLETTER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`NEWSLETTER_ID`';
        }
        if ($this->isColumnModified(NewsletterPostPeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`DATE`';
        }
        if ($this->isColumnModified(NewsletterPostPeer::TEXT)) {
            $modifiedColumns[':p' . $index++]  = '`TEXT`';
        }

        $sql = sprintf(
            'INSERT INTO `newsletters_posts` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = NewsletterPostPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = NewsletterPostPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['NewsletterPost'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['NewsletterPost'][$this->getPrimaryKey()] = true;
        $keys = NewsletterPostPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNewsletterId(),
            $keys[2] => $this->getDate(),
            $keys[3] => ($includeLazyLoadColumns) ? $this->getText() : null,
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NewsletterPostPeer::ID)) $criteria->add(NewsletterPostPeer::ID, $this->id);
        if ($this->isColumnModified(NewsletterPostPeer::NEWSLETTER_ID)) $criteria->add(NewsletterPostPeer::NEWSLETTER_ID, $this->newsletter_id);
        if ($this->isColumnModified(NewsletterPostPeer::DATE)) $criteria->add(NewsletterPostPeer::DATE, $this->date);
        if ($this->isColumnModified(NewsletterPostPeer::TEXT)) $criteria->add(NewsletterPostPeer::TEXT, $this->text);
    ...
    {
        $criteria = new Criteria(NewsletterPostPeer::DATABASE_NAME);
        $criteria->add(NewsletterPostPeer::ID, $this->id);
    ...
    {
        if (self::$peer === null) {
            self::$peer = new NewsletterPostPeer();
        }
    ...
    public function getNewsletter(PropelPDO $con = null)
    {
        if ($this->aNewsletter === null && ($this->newsletter_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aNewsletter->addNewsletterPosts($this);
             */
        }
