...
abstract class BaseReportPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'ContentId', 'AuthorId', 'Date', 'Text', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'contentId', 'authorId', 'date', 'text', ),
        BasePeer::TYPE_COLNAME => array (ReportPeer::ID, ReportPeer::CONTENT_ID, ReportPeer::AUTHOR_ID, ReportPeer::DATE, ReportPeer::TEXT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CONTENT_ID', 'AUTHOR_ID', 'DATE', 'TEXT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'content_id', 'author_id', 'date', 'text', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ContentId' => 1, 'AuthorId' => 2, 'Date' => 3, 'Text' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'contentId' => 1, 'authorId' => 2, 'date' => 3, 'text' => 4, ),
        BasePeer::TYPE_COLNAME => array (ReportPeer::ID => 0, ReportPeer::CONTENT_ID => 1, ReportPeer::AUTHOR_ID => 2, ReportPeer::DATE => 3, ReportPeer::TEXT => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CONTENT_ID' => 1, 'AUTHOR_ID' => 2, 'DATE' => 3, 'TEXT' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'content_id' => 1, 'author_id' => 2, 'date' => 3, 'text' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ReportPeer::CONTENT_ID);
            $criteria->addSelectColumn(ReportPeer::AUTHOR_ID);
    ...
    public static function doCountJoinContent(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ReportPeer::CONTENT_ID, ContentPeer::ID, $join_behavior);
    ...
    public static function doCountJoinAuthor(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ReportPeer::AUTHOR_ID, UserPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Report objects pre-filled with their Content objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinContent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Report) to $obj2 (Content)
                $obj2->addReport($obj1);
    ...
    /**
     * Selects a collection of Report objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Report objects.
    ...
    public static function doSelectJoinAuthor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Report) to $obj2 (User)
                $obj2->addReport($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Report) to the collection in $obj2 (Content)
                $obj2->addReport($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Report) to the collection in $obj3 (User)
                $obj3->addReport($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Report objects pre-filled with all related objects except Content.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptContent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = ReportPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Report) to the collection in $obj2 (User)
                $obj2->addReport($obj1);
    ...
    /**
     * Selects a collection of Report objects pre-filled with all related objects except Author.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
