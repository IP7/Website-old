...
abstract class BaseCommentPeer {
    ...
    const TABLE_NAME = 'content_comments';
    ...
    const ID = 'content_comments.ID';

    /** the column name for the REPLY_TO_ID field */
    const REPLY_TO_ID = 'content_comments.REPLY_TO_ID';

    /** the column name for the CONTENT_ID field */
    const CONTENT_ID = 'content_comments.CONTENT_ID';

    /** the column name for the AUTHOR_ID field */
    const AUTHOR_ID = 'content_comments.AUTHOR_ID';

    /** the column name for the DATE field */
    const DATE = 'content_comments.DATE';

    /** the column name for the TEXT field */
    const TEXT = 'content_comments.TEXT';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommentPeer::REPLY_TO_ID);
            $criteria->addSelectColumn(CommentPeer::CONTENT_ID);
            $criteria->addSelectColumn(CommentPeer::AUTHOR_ID);
            $criteria->addSelectColumn(CommentPeer::DATE);
        } else {
            $criteria->addSelectColumn($alias . '.ID');
            $criteria->addSelectColumn($alias . '.REPLY_TO_ID');
    ...
    /**
     * Selects a collection of Comment objects pre-filled with their Content objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinContent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to $obj2 (Content)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to the collection in $obj2 (Content)
                $obj2->addComment($obj1);
    ...
    /**
     * Returns the number of rows matching criteria, joining the related ReplyToComment table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptReplyToComment(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
    ...
    /**
     * Selects a collection of Comment objects pre-filled with all related objects except ReplyToComment.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptReplyToComment(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
    ...
    /**
     * Selects a collection of Comment objects pre-filled with all related objects except Content.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Comment objects pre-filled with all related objects except Author.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Deletes all rows from the content_comments table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $updateValues->add(CommentPeer::REPLY_TO_ID, null);
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($obj->isNew() || $obj->isColumnModified(CommentPeer::TEXT))
            $columns[CommentPeer::TEXT] = $obj->getText();
