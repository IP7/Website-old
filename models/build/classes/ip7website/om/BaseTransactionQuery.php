...
abstract class BaseTransactionQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'infop7db', $modelName = 'Transaction', $modelAlias = null)
    {
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TransactionPeer::DESCRIPTION, $description, $comparison);
    }
    ...
    public function filterByValidated($validated = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TransactionPeer::VALIDATED, $validated, $comparison);
    }
