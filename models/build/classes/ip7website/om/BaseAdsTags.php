...
/**
 * Base class that represents a row from the 'ads_tags' table.
 *
 *
 *
 * @package    propel.generator.ip7website.om
 */
abstract class BaseAdsTags extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'AdsTagsPeer';
     ...
     * @return AdsTags The current object (for fluent API support)
     */
    public function setTagId($v)
    {
        ...
        if ($this->tag_id !== $v) {
            $this->tag_id = $v;
            $this->modifiedColumns[] = AdsTagsPeer::TAG_ID;
        }
    ...
    public function setAdId($v)
    {
        ...
        if ($this->ad_id !== $v) {
            $this->ad_id = $v;
            $this->modifiedColumns[] = AdsTagsPeer::AD_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = AdsTagsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating AdsTags object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AdsTagsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AdsTagsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AdsTagsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AdsTagsPeer::TAG_ID)) {
            $modifiedColumns[':p' . $index++]  = '`TAG_ID`';
        }
        if ($this->isColumnModified(AdsTagsPeer::AD_ID)) {
            $modifiedColumns[':p' . $index++]  = '`AD_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `ads_tags` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AdsTagsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AdsTagsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AdsTags'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AdsTags'][serialize($this->getPrimaryKey())] = true;
        $keys = AdsTagsPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdsTagsPeer::TAG_ID)) $criteria->add(AdsTagsPeer::TAG_ID, $this->tag_id);
        if ($this->isColumnModified(AdsTagsPeer::AD_ID)) $criteria->add(AdsTagsPeer::AD_ID, $this->ad_id);
    ...
    {
        $criteria = new Criteria(AdsTagsPeer::DATABASE_NAME);
        $criteria->add(AdsTagsPeer::TAG_ID, $this->tag_id);
        $criteria->add(AdsTagsPeer::AD_ID, $this->ad_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getTagId()) && (null === $this->getAdId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of AdsTags (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AdsTags Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AdsTagsPeer::DEFAULT_STRING_FORMAT);
    }
