...
abstract class BaseNotePeer {
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NotePeer::COURSE_ID);
            $criteria->addSelectColumn(NotePeer::SCORE);
        } else {
    ...
    /**
     * Selects a collection of Note objects pre-filled with their Course objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Note objects.
    ...
    public static function doSelectJoinCourse(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Note) to $obj2 (Course)
                $obj2->addNote($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Note) to the collection in $obj3 (Course)
                $obj3->addNote($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Note objects pre-filled with all related objects except User.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = NotePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Note) to the collection in $obj2 (Course)
                $obj2->addNote($obj1);
    ...
    /**
     * Selects a collection of Note objects pre-filled with all related objects except Course.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($obj->isNew() || $obj->isColumnModified(NotePeer::SCORE))
            $columns[NotePeer::SCORE] = $obj->getScore();
