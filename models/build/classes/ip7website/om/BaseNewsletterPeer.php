...
abstract class BaseNewsletterPeer {
    ...
    const NAME = 'newsletters.NAME';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'newsletters.DESCRIPTION';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NewsletterPeer::NAME);
            $criteria->addSelectColumn(NewsletterPeer::DESCRIPTION);
        } else {
    ...
    public static function clearRelatedInstancePool()
    {
        ...
        // Invalidate objects in NewsletterPostPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            NewsletterPeer::doOnDeleteSetNull(new Criteria(NewsletterPeer::DATABASE_NAME), $con);
    ...
    protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $updateValues->add(CursusPeer::NEWSLETTER_ID, null);
            ...
            $updateValues->add(NewsletterPostPeer::NEWSLETTER_ID, null);
