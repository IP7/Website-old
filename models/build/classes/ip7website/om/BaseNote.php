...
abstract class BaseNote extends BaseObject implements Persistent
{
    ...
    public function setCourseId($v)
    {
        ...
        if ($this->course_id !== $v) {
            $this->course_id = $v;
            $this->modifiedColumns[] = NotePeer::COURSE_ID;
        }
    ...
    public function setScore($v)
    {
        ...
        if ($this->score !== $v) {
            $this->score = $v;
            $this->modifiedColumns[] = NotePeer::SCORE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->score = ($row[$startcol + 3] !== null) ? (double) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = NotePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NotePeer::COURSE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`COURSE_ID`';
        }
        if ($this->isColumnModified(NotePeer::SCORE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NotePeer::COURSE_ID)) $criteria->add(NotePeer::COURSE_ID, $this->course_id);
        if ($this->isColumnModified(NotePeer::SCORE)) $criteria->add(NotePeer::SCORE, $this->score);
