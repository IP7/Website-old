...
/**
 * Base class that represents a row from the 'events_types' table.
 *
 *
 *
...
abstract class BaseEventType extends BaseObject implements Persistent
{
    ...
    public function setShortName($v)
    {
        ...
        if ($this->short_name !== $v) {
            $this->short_name = $v;
            $this->modifiedColumns[] = EventTypePeer::SHORT_NAME;
        }
    ...
    public function setAccessRights($v)
    {
        ...
        if ($this->access_rights !== $v) {
            ...
            $this->modifiedColumns[] = EventTypePeer::ACCESS_RIGHTS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = EventTypePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EventTypePeer::SHORT_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`short_name`';
        }
        if ($this->isColumnModified(EventTypePeer::ACCESS_RIGHTS)) {
            $modifiedColumns[':p' . $index++]  = '`access_rights`';
        }

        $sql = sprintf(
            'INSERT INTO `events_types` (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventTypePeer::SHORT_NAME)) $criteria->add(EventTypePeer::SHORT_NAME, $this->short_name);
        if ($this->isColumnModified(EventTypePeer::ACCESS_RIGHTS)) $criteria->add(EventTypePeer::ACCESS_RIGHTS, $this->access_rights);
