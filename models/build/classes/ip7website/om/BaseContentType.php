 ...
 */
abstract class BaseContentType extends BaseObject 
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ContentTypePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function setAlerts(PropelCollection $alerts, PropelPDO $con = null)
    {
        ...
        foreach ($this->alertsScheduledForDeletion as $alertRemoved) {
            $alertRemoved->setContentType(null);
        }
