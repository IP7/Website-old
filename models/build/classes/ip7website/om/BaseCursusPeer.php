...
abstract class BaseCursusPeer {
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (self::ID, self::SHORT_NAME, self::NAME, self::DESCRIPTION, self::RESPONSABLE_ID, self::NEWSLETTER_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::SHORT_NAME => 1, self::NAME => 2, self::DESCRIPTION => 3, self::RESPONSABLE_ID => 4, self::NEWSLETTER_ID => 5, ),
