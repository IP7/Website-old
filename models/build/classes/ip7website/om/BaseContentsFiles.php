...
abstract class BaseContentsFiles extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'ContentsFilesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ContentsFilesPeer
     */
    ...
    public function setContentId($v)
    {
        ...
        if ($this->content_id !== $v) {
            $this->content_id = $v;
            $this->modifiedColumns[] = ContentsFilesPeer::CONTENT_ID;
        }
    ...
    public function setFileId($v)
    {
        ...
        if ($this->file_id !== $v) {
            $this->file_id = $v;
            $this->modifiedColumns[] = ContentsFilesPeer::FILE_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            throw new PropelException("Error populating ContentsFiles object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ContentsFilesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ContentsFilesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ContentsFilesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `contents_files` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ContentsFilesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ContentsFilesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ContentsFiles'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ContentsFiles'][serialize($this->getPrimaryKey())] = true;
        $keys = ContentsFilesPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContentsFilesPeer::CONTENT_ID)) $criteria->add(ContentsFilesPeer::CONTENT_ID, $this->content_id);
        if ($this->isColumnModified(ContentsFilesPeer::FILE_ID)) $criteria->add(ContentsFilesPeer::FILE_ID, $this->file_id);
    ...
    {
        $criteria = new Criteria(ContentsFilesPeer::DATABASE_NAME);
        $criteria->add(ContentsFilesPeer::CONTENT_ID, $this->content_id);
        $criteria->add(ContentsFilesPeer::FILE_ID, $this->file_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getContentId()) && (null === $this->getFileId());
    }
    ...
    {
        if (self::$peer === null) {
            self::$peer = new ContentsFilesPeer();
        }
    ...
    public function getContent(PropelPDO $con = null)
    {
        if ($this->aContent === null && ($this->content_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aContent->addContentsFiless($this);
             */
        }
    ...
    public function getFile(PropelPDO $con = null)
    {
        if ($this->aFile === null && ($this->file_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aFile->addContentsFiless($this);
             */
        }
