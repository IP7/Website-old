...
abstract class BaseUserPeer {
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'PasswordHash', 'Type', 'Firstname', 'Lastname', 'Email', 'Phone', 'Address', 'Website', 'BirthDate', 'FirstEntry', 'LastEntry', 'LastVisit', 'VisitsNb', 'ConfigShowEmail', 'ConfigShowPhone', 'ConfigShowRealName', 'Deactivated', 'IsATeacher', 'IsAStudent', 'AvatarId', 'Description', 'Comments', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'passwordHash', 'type', 'firstname', 'lastname', 'email', 'phone', 'address', 'website', 'birthDate', 'firstEntry', 'lastEntry', 'lastVisit', 'visitsNb', 'configShowEmail', 'configShowPhone', 'configShowRealName', 'deactivated', 'isATeacher', 'isAStudent', 'avatarId', 'description', 'comments', ),
        BasePeer::TYPE_COLNAME => array (self::ID, self::USERNAME, self::PASSWORD_HASH, self::TYPE, self::FIRSTNAME, self::LASTNAME, self::EMAIL, self::PHONE, self::ADDRESS, self::WEBSITE, self::BIRTH_DATE, self::FIRST_ENTRY, self::LAST_ENTRY, self::LAST_VISIT, self::VISITS_NB, self::CONFIG_SHOW_EMAIL, self::CONFIG_SHOW_PHONE, self::CONFIG_SHOW_REAL_NAME, self::DEACTIVATED, self::IS_A_TEACHER, self::IS_A_STUDENT, self::AVATAR_ID, self::DESCRIPTION, self::COMMENTS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'PASSWORD_HASH', 'TYPE', 'FIRSTNAME', 'LASTNAME', 'EMAIL', 'PHONE', 'ADDRESS', 'WEBSITE', 'BIRTH_DATE', 'FIRST_ENTRY', 'LAST_ENTRY', 'LAST_VISIT', 'VISITS_NB', 'CONFIG_SHOW_EMAIL', 'CONFIG_SHOW_PHONE', 'CONFIG_SHOW_REAL_NAME', 'DEACTIVATED', 'IS_A_TEACHER', 'IS_A_STUDENT', 'AVATAR_ID', 'DESCRIPTION', 'COMMENTS', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'password_hash', 'type', 'firstname', 'lastname', 'email', 'phone', 'address', 'website', 'birth_date', 'first_entry', 'last_entry', 'last_visit', 'visits_nb', 'config_show_email', 'config_show_phone', 'config_show_real_name', 'deactivated', 'is_a_teacher', 'is_a_student', 'avatar_id', 'description', 'comments', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'PasswordHash' => 2, 'Type' => 3, 'Firstname' => 4, 'Lastname' => 5, 'Email' => 6, 'Phone' => 7, 'Address' => 8, 'Website' => 9, 'BirthDate' => 10, 'FirstEntry' => 11, 'LastEntry' => 12, 'LastVisit' => 13, 'VisitsNb' => 14, 'ConfigShowEmail' => 15, 'ConfigShowPhone' => 16, 'ConfigShowRealName' => 17, 'Deactivated' => 18, 'IsATeacher' => 19, 'IsAStudent' => 20, 'AvatarId' => 21, 'Description' => 22, 'Comments' => 23, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'passwordHash' => 2, 'type' => 3, 'firstname' => 4, 'lastname' => 5, 'email' => 6, 'phone' => 7, 'address' => 8, 'website' => 9, 'birthDate' => 10, 'firstEntry' => 11, 'lastEntry' => 12, 'lastVisit' => 13, 'visitsNb' => 14, 'configShowEmail' => 15, 'configShowPhone' => 16, 'configShowRealName' => 17, 'deactivated' => 18, 'isATeacher' => 19, 'isAStudent' => 20, 'avatarId' => 21, 'description' => 22, 'comments' => 23, ),
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USERNAME => 1, self::PASSWORD_HASH => 2, self::TYPE => 3, self::FIRSTNAME => 4, self::LASTNAME => 5, self::EMAIL => 6, self::PHONE => 7, self::ADDRESS => 8, self::WEBSITE => 9, self::BIRTH_DATE => 10, self::FIRST_ENTRY => 11, self::LAST_ENTRY => 12, self::LAST_VISIT => 13, self::VISITS_NB => 14, self::CONFIG_SHOW_EMAIL => 15, self::CONFIG_SHOW_PHONE => 16, self::CONFIG_SHOW_REAL_NAME => 17, self::DEACTIVATED => 18, self::IS_A_TEACHER => 19, self::IS_A_STUDENT => 20, self::AVATAR_ID => 21, self::DESCRIPTION => 22, self::COMMENTS => 23, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'PASSWORD_HASH' => 2, 'TYPE' => 3, 'FIRSTNAME' => 4, 'LASTNAME' => 5, 'EMAIL' => 6, 'PHONE' => 7, 'ADDRESS' => 8, 'WEBSITE' => 9, 'BIRTH_DATE' => 10, 'FIRST_ENTRY' => 11, 'LAST_ENTRY' => 12, 'LAST_VISIT' => 13, 'VISITS_NB' => 14, 'CONFIG_SHOW_EMAIL' => 15, 'CONFIG_SHOW_PHONE' => 16, 'CONFIG_SHOW_REAL_NAME' => 17, 'DEACTIVATED' => 18, 'IS_A_TEACHER' => 19, 'IS_A_STUDENT' => 20, 'AVATAR_ID' => 21, 'DESCRIPTION' => 22, 'COMMENTS' => 23, ),
