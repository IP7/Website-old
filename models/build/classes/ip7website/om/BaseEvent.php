...
abstract class BaseEvent extends BaseObject implements Persistent
{
    ...
    public function setBeginning($v)
    {
        ...
        if ($this->beginning !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = EventPeer::BEGINNING;
            }
        } // if either are not null
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EventPeer::BEGINNING)) {
            $modifiedColumns[':p' . $index++]  = '`BEGINNING`';
        }
        if ($this->isColumnModified(EventPeer::END)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventPeer::BEGINNING)) $criteria->add(EventPeer::BEGINNING, $this->beginning);
