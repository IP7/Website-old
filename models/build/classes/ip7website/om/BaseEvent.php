...
abstract class BaseEvent extends BaseObject implements Persistent
{
     ...
     */
    public function getStartDate($format = 'd-m-Y H:i:s')
    {
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getEndDate($format = 'd-m-Y H:i:s')
    {
    ...
    public function setAuthorId($v)
    {
        ...
        if ($this->author_id !== $v) {
            $this->author_id = $v;
            $this->modifiedColumns[] = EventPeer::AUTHOR_ID;
        }
    ...
    public function setAccessRights($v)
    {
        ...
        if ($this->access_rights !== $v) {
            ...
            $this->modifiedColumns[] = EventPeer::ACCESS_RIGHTS;
        }
    ...
    public function setFee($v)
    {
        ...
        if ($this->fee !== $v) {
            $this->fee = $v;
            $this->modifiedColumns[] = EventPeer::FEE;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EventPeer::AUTHOR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`author_id`';
        }
        if ($this->isColumnModified(EventPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(EventPeer::ACCESS_RIGHTS)) {
        ...
        if ($this->isColumnModified(EventPeer::FEE)) {
            $modifiedColumns[':p' . $index++]  = '`fee`';
        }
        if ($this->isColumnModified(EventPeer::START_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`start_date`';
        }
        if ($this->isColumnModified(EventPeer::END_DATE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventPeer::AUTHOR_ID)) $criteria->add(EventPeer::AUTHOR_ID, $this->author_id);
        if ($this->isColumnModified(EventPeer::TITLE)) $criteria->add(EventPeer::TITLE, $this->title);
        if ($this->isColumnModified(EventPeer::ACCESS_RIGHTS)) $criteria->add(EventPeer::ACCESS_RIGHTS, $this->access_rights);
        ...
        if ($this->isColumnModified(EventPeer::FEE)) $criteria->add(EventPeer::FEE, $this->fee);
