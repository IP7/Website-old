...
/**
 * Base static class for performing query and update operations on the 'events_types' table.
 *
 *
 *
...
abstract class BaseEventTypePeer
{
    ...
    const ID = 'events_types.id';

    /** the column name for the name field */
    const NAME = 'events_types.name';

    /** the column name for the short_name field */
    const SHORT_NAME = 'events_types.short_name';

    /** the column name for the access_rights field */
    const ACCESS_RIGHTS = 'events_types.access_rights';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (EventTypePeer::ID, EventTypePeer::NAME, EventTypePeer::SHORT_NAME, EventTypePeer::ACCESS_RIGHTS, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (EventTypePeer::ID => 0, EventTypePeer::NAME => 1, EventTypePeer::SHORT_NAME => 2, EventTypePeer::ACCESS_RIGHTS => 3, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(EventTypePeer::SHORT_NAME);
            $criteria->addSelectColumn(EventTypePeer::ACCESS_RIGHTS);
        } else {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to events_types
    ...
    /**
     * Deletes all rows from the events_types table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
