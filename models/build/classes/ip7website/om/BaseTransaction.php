...
abstract class BaseTransaction extends BaseObject 
{
    ...
    public function setValidated($v)
    {
        ...
        if ($this->validated !== $v) {
            $this->validated = $v;
            $this->modifiedColumns[] = TransactionPeer::VALIDATED;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = TransactionPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TransactionPeer::DESCRIPTION)) {
        ...
        if ($this->isColumnModified(TransactionPeer::VALIDATED)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TransactionPeer::VALIDATED)) $criteria->add(TransactionPeer::VALIDATED, $this->validated);
