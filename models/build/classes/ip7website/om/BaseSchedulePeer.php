...
/**
 * Base static class for performing query and update operations on the 'schedules' table.
 *
 *
 *
...
abstract class BaseSchedulePeer
{
    ...
    const END = 'schedules.END';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of Schedule objects.
    ...
    {
        $toNames = SchedulePeer::getFieldNames($toType);
        $key = isset(SchedulePeer::$fieldKeys[$fromType][$name]) ? SchedulePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(SchedulePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, SchedulePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return SchedulePeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. SchedulePeer::COLUMN_NAME).
     * @return string
     */
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(SchedulePeer::DATABASE_NAME); // Set the correct dbName
    ...
    {
        return SchedulePeer::populateObjects(SchedulePeer::doSelectStmt($criteria, $con));
    }
    /**
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            SchedulePeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(SchedulePeer::$instances[$key]);
        }
     ...
     * @return   Schedule Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(SchedulePeer::$instances[$key])) {
                return SchedulePeer::$instances[$key];
            }
        }
    ...
    {
        SchedulePeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to schedules
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = SchedulePeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = SchedulePeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                SchedulePeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
    ...
    {
        $key = SchedulePeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = SchedulePeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + SchedulePeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = SchedulePeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doSelectJoinCursus(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Schedule) to $obj2 (Cursus)
    ...
    {
        return Propel::getDatabaseMap(SchedulePeer::DATABASE_NAME)->getTable(SchedulePeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseSchedulePeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseSchedulePeer::TABLE_NAME)) {
    ...
    {
        return SchedulePeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a Schedule or Criteria object.
     *
     * @param      mixed $values Criteria or Schedule object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from Schedule object
        }

        if ($criteria->containsKey(SchedulePeer::ID) && $criteria->keyContainsValue(SchedulePeer::ID) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a Schedule or Criteria object.
     *
     * @param      mixed $values Criteria or Schedule object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(SchedulePeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(SchedulePeer::ID);
            $value = $criteria->remove(SchedulePeer::ID);
            if ($value) {
                $selectCriteria->add(SchedulePeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(SchedulePeer::TABLE_NAME);
            }

        } else { // $values is Schedule object
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += SchedulePeer::doOnDeleteCascade(new Criteria(SchedulePeer::DATABASE_NAME), $con);
            $affectedRows += BasePeer::doDeleteAll(SchedulePeer::TABLE_NAME, $con, SchedulePeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            SchedulePeer::clearInstancePool();
            SchedulePeer::clearRelatedInstancePool();
            $con->commit();
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += SchedulePeer::doOnDeleteCascade($c, $con);
            ...
            if ($values instanceof Criteria) {
                ...
                SchedulePeer::removeInstanceFromPool($values);
            } else { // it's a primary key, or an array of pks
                foreach ((array) $values as $singleval) {
                    SchedulePeer::removeInstanceFromPool($singleval);
                }
            }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(SchedulesCoursesPeer::SCHEDULE_ID, $obj->getId());
    ...
    /**
     * Validates all modified columns of given Schedule object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      Schedule $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        return BasePeer::doValidate(SchedulePeer::DATABASE_NAME, SchedulePeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = SchedulePeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
...
//
BaseSchedulePeer::buildTableMap();
