 ...
 */
abstract class BaseToken extends BaseObject 
{
    ...
    public function setExpirationDate($v)
    {
        ...
        if ($this->expiration_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TokenPeer::EXPIRATION_DATE;
            }
    ...
    public function setRights($v)
    {
        ...
        if ($this->rights !== $v) {
            $this->rights = $v;
            $this->modifiedColumns[] = TokenPeer::RIGHTS;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = TokenPeer::VALUE;
        }
