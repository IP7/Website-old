...
/**
 * Base class that represents a row from the 'contents_tags' table.
 *
 *
 *
 * @package    propel.generator.ip7website.om
 */
abstract class BaseContentsTags extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ContentsTagsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ContentsTagsPeer
     */
     ...
     * @return ContentsTags The current object (for fluent API support)
     */
    public function setTagId($v)
    {
        ...
        if ($this->tag_id !== $v) {
            $this->tag_id = $v;
            $this->modifiedColumns[] = ContentsTagsPeer::TAG_ID;
        }
    ...
    public function setContentId($v)
    {
        ...
        if ($this->content_id !== $v) {
            $this->content_id = $v;
            $this->modifiedColumns[] = ContentsTagsPeer::CONTENT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ContentsTagsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ContentsTags object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ContentsTagsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ContentsTagsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ContentsTagsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ContentsTagsPeer::TAG_ID)) {
            $modifiedColumns[':p' . $index++]  = '`TAG_ID`';
        }
        if ($this->isColumnModified(ContentsTagsPeer::CONTENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`CONTENT_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `contents_tags` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ContentsTagsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ContentsTagsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ContentsTags'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ContentsTags'][serialize($this->getPrimaryKey())] = true;
        $keys = ContentsTagsPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContentsTagsPeer::TAG_ID)) $criteria->add(ContentsTagsPeer::TAG_ID, $this->tag_id);
        if ($this->isColumnModified(ContentsTagsPeer::CONTENT_ID)) $criteria->add(ContentsTagsPeer::CONTENT_ID, $this->content_id);
    ...
    {
        $criteria = new Criteria(ContentsTagsPeer::DATABASE_NAME);
        $criteria->add(ContentsTagsPeer::TAG_ID, $this->tag_id);
        $criteria->add(ContentsTagsPeer::CONTENT_ID, $this->content_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getTagId()) && (null === $this->getContentId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ContentsTags (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ContentsTags Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ContentsTagsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ContentsTagsPeer();
        }
    ...
    public function getTag(PropelPDO $con = null)
    {
        if ($this->aTag === null && ($this->tag_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTag->addContentsTagss($this);
             */
        }
    ...
    public function getContent(PropelPDO $con = null)
    {
        if ($this->aContent === null && ($this->content_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aContent->addContentsTagss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ContentsTagsPeer::DEFAULT_STRING_FORMAT);
    }
