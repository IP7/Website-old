...
/**
 * Base class that represents a row from the 'courses_urls' table.
 *
 *
 *
 * @package    propel.generator.ip7website.om
 */
abstract class BaseCourseUrl extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CourseUrlPeer';
     ...
     * @return CourseUrl The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CourseUrlPeer::ID;
        }
    ...
    public function setCourseId($v)
    {
        ...
        if ($this->course_id !== $v) {
            $this->course_id = $v;
            $this->modifiedColumns[] = CourseUrlPeer::COURSE_ID;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[] = CourseUrlPeer::TEXT;
        }
    ...
    public function setUrl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[] = CourseUrlPeer::URL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            throw new PropelException("Error populating CourseUrl object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CourseUrlPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CourseUrlQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CourseUrlPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `courses_urls` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CourseUrlPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CourseUrlPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CourseUrl'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CourseUrl'][$this->getPrimaryKey()] = true;
        $keys = CourseUrlPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CourseUrlPeer::ID)) $criteria->add(CourseUrlPeer::ID, $this->id);
        if ($this->isColumnModified(CourseUrlPeer::COURSE_ID)) $criteria->add(CourseUrlPeer::COURSE_ID, $this->course_id);
        if ($this->isColumnModified(CourseUrlPeer::TEXT)) $criteria->add(CourseUrlPeer::TEXT, $this->text);
        if ($this->isColumnModified(CourseUrlPeer::URL)) $criteria->add(CourseUrlPeer::URL, $this->url);
    ...
    {
        $criteria = new Criteria(CourseUrlPeer::DATABASE_NAME);
        $criteria->add(CourseUrlPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CourseUrl (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CourseUrl Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CourseUrlPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CourseUrlPeer();
        }
    ...
    public function getCourse(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCourse === null && ($this->course_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCourse->addCourseUrls($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CourseUrlPeer::DEFAULT_STRING_FORMAT);
    }
