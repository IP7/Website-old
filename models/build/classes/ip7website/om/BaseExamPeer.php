...
abstract class BaseExamPeer {
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ExamPeer::BEGINNING);
    ...
    {
        $key = ExamPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = ExamPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + ExamPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = ExamPeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doCountJoinCourse(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ExamPeer::COURSE_ID, CoursePeer::ID, $join_behavior);
    ...
    public static function doSelectJoinCourse(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        ExamPeer::addSelectColumns($criteria);
        $startcol = ExamPeer::NUM_HYDRATE_COLUMNS;
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        ExamPeer::addSelectColumns($criteria);
        $startcol2 = ExamPeer::NUM_HYDRATE_COLUMNS;
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseExamPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseExamPeer::TABLE_NAME)) {
    ...
    /**
     * Performs an UPDATE on the database, given a Exam or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(ExamPeer::ID);
            if ($value) {
                $selectCriteria->add(ExamPeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(ExamPeer::TABLE_NAME);
            }
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(ExamPeer::TABLE_NAME, $con, ExamPeer::DATABASE_NAME);
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        return BasePeer::doValidate(ExamPeer::DATABASE_NAME, ExamPeer::TABLE_NAME, $columns);
    }
