 ...
 */
abstract class BaseReport extends BaseObject 
{
    ...
    public function setContentId($v)
    {
        ...
        if ($this->content_id !== $v) {
            $this->content_id = $v;
            $this->modifiedColumns[] = ReportPeer::CONTENT_ID;
        }
    ...
    public function setAuthorId($v)
    {
        ...
        if ($this->author_id !== $v) {
            $this->author_id = $v;
            $this->modifiedColumns[] = ReportPeer::AUTHOR_ID;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ReportPeer::DATE;
            }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[] = ReportPeer::TEXT;
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ReportPeer::CONTENT_ID)) $criteria->add(ReportPeer::CONTENT_ID, $this->content_id);
        if ($this->isColumnModified(ReportPeer::AUTHOR_ID)) $criteria->add(ReportPeer::AUTHOR_ID, $this->author_id);
        if ($this->isColumnModified(ReportPeer::DATE)) $criteria->add(ReportPeer::DATE, $this->date);
        if ($this->isColumnModified(ReportPeer::TEXT)) $criteria->add(ReportPeer::TEXT, $this->text);
