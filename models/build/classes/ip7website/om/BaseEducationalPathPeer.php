...
abstract class BaseEducationalPathPeer
{
    ...
    const TABLE_NAME = 'educational_paths';

    /** the related Propel class for this table */
    const OM_CLASS = 'EducationalPath';
    ...
    /**
     * An identiy map to hold any loaded instances of EducationalPath objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array EducationalPath[]
     */
     ...
     * @param      string $column The column name for current table. (i.e. EducationalPathPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(EducationalPathPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(EducationalPathPeer::ID);
            $criteria->addSelectColumn(EducationalPathPeer::SHORT_NAME);
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(EducationalPathPeer::TABLE_NAME);
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = EducationalPathPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return EducationalPathPeer::populateObjects(EducationalPathPeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param      EducationalPath $obj A EducationalPath object.
     ...
     *
     * @param      mixed $value A EducationalPath object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof EducationalPath) {
                $key = (string) $value->getId();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or EducationalPath object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = EducationalPathPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = EducationalPathPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                EducationalPathPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (EducationalPath object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = EducationalPathPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = EducationalPathPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + EducationalPathPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = EducationalPathPeer::OM_CLASS;
            $obj = new $cls();
    ...
    /**
     * Selects a collection of EducationalPath objects pre-filled with their Cursus objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of EducationalPath objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCursus(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        EducationalPathPeer::addSelectColumns($criteria);
        $startcol = EducationalPathPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = EducationalPathPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = EducationalPathPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                EducationalPathPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (EducationalPath) to $obj2 (Cursus)
                $obj2->addEducationalPath($obj1);
    ...
    /**
     * Selects a collection of EducationalPath objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of EducationalPath objects.
    ...
    public static function doSelectJoinResponsable(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (EducationalPath) to $obj2 (User)
                $obj2->addEducationalPathResponsability($obj1);
    ...
    /**
     * Selects a collection of EducationalPath objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        EducationalPathPeer::addSelectColumns($criteria);
        $startcol2 = EducationalPathPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (EducationalPath) to the collection in $obj2 (Cursus)
                $obj2->addEducationalPath($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (EducationalPath) to the collection in $obj3 (User)
                $obj3->addEducationalPathResponsability($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of EducationalPath objects pre-filled with all related objects except Cursus.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptCursus(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = EducationalPathPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (EducationalPath) to the collection in $obj2 (User)
                $obj2->addEducationalPathResponsability($obj1);
    ...
    /**
     * Selects a collection of EducationalPath objects pre-filled with all related objects except Responsable.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseEducationalPathPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseEducationalPathPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new EducationalPathTableMap());
      }
    }
    ...
    /**
     * Performs an INSERT on the database, given a EducationalPath or Criteria object.
     *
     * @param      mixed $values Criteria or EducationalPath object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from EducationalPath object
        }

        if ($criteria->containsKey(EducationalPathPeer::ID) && $criteria->keyContainsValue(EducationalPathPeer::ID) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a EducationalPath or Criteria object.
     *
     * @param      mixed $values Criteria or EducationalPath object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(EducationalPathPeer::ID);
            $value = $criteria->remove(EducationalPathPeer::ID);
            if ($value) {
                $selectCriteria->add(EducationalPathPeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(EducationalPathPeer::TABLE_NAME);
            }

        } else { // $values is EducationalPath object
    ...
    /**
     * Deletes all rows from the educational_paths table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += EducationalPathPeer::doOnDeleteCascade(new Criteria(EducationalPathPeer::DATABASE_NAME), $con);
            $affectedRows += BasePeer::doDeleteAll(EducationalPathPeer::TABLE_NAME, $con, EducationalPathPeer::DATABASE_NAME);
    ...
    /**
     * Performs a DELETE on the database, given a EducationalPath or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or EducationalPath object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof EducationalPath) { // it's a model object
        ...
        try {
            ...
            if ($values instanceof Criteria) {
                ...
                EducationalPathPeer::removeInstanceFromPool($values);
            } else { // it's a primary key, or an array of pks
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = EducationalPathPeer::doSelect($criteria, $con);
    ...
    /**
     * Validates all modified columns of given EducationalPath object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      EducationalPath $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(EducationalPathPeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(EducationalPathPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(EducationalPathPeer::DATABASE_NAME, EducationalPathPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = EducationalPathPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(EducationalPathPeer::DATABASE_NAME);
        $criteria->add(EducationalPathPeer::ID, $pk);

        $v = EducationalPathPeer::doSelect($criteria, $con);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(EducationalPathPeer::DATABASE_NAME);
            $criteria->add(EducationalPathPeer::ID, $pks, Criteria::IN);
            $objs = EducationalPathPeer::doSelect($criteria, $con);
        }

        return $objs;
    }

} // BaseEducationalPathPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseEducationalPathPeer::buildTableMap();
