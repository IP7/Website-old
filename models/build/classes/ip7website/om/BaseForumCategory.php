...
abstract class BaseForumCategory extends BaseObject implements Persistent
{
     ...
     */
    protected $forumCategorysRelatedByIdScheduledForDeletion = null;
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ForumCategoryPeer::ID;
        }
    ...
    public function setParentId($v)
    {
        ...
        if ($this->parent_id !== $v) {
            $this->parent_id = $v;
            $this->modifiedColumns[] = ForumCategoryPeer::PARENT_ID;
        }
    ...
    public function setAccessRights($v)
    {
        ...
        if ($this->access_rights !== $v) {
            ...
            $this->modifiedColumns[] = ForumCategoryPeer::ACCESS_RIGHTS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = ForumCategoryPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        if ($deep) {  // also de-associate any related objects?
            ...
            $this->aParentCategory = null;
            $this->collForumCategorysRelatedById = null;
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ForumCategoryQuery::create()
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->forumCategorysRelatedByIdScheduledForDeletion !== null) {
                if (!$this->forumCategorysRelatedByIdScheduledForDeletion->isEmpty()) {
                    foreach ($this->forumCategorysRelatedByIdScheduledForDeletion as $forumCategoryRelatedById) {
                        // need to save related object because we set the relation to null
                        $forumCategoryRelatedById->save($con);
                    }
                    $this->forumCategorysRelatedByIdScheduledForDeletion = null;
                }
            }

            if ($this->collForumCategorysRelatedById !== null) {
                foreach ($this->collForumCategorysRelatedById as $referrerFK) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ForumCategoryPeer::ACCESS_RIGHTS)) {
            $modifiedColumns[':p' . $index++]  = '`ACCESS_RIGHTS`';
        }

        $sql = sprintf(
            'INSERT INTO `forum_categories` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['ForumCategory'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ForumCategory'][$this->getPrimaryKey()] = true;
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collForumCategorysRelatedById) {
                $result['ForumCategorysRelatedById'] = $this->collForumCategorysRelatedById->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
            if (null !== $this->collForumTopics) {
                $result['ForumTopics'] = $this->collForumTopics->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    {
        $criteria = new Criteria(ForumCategoryPeer::DATABASE_NAME);
        $criteria->add(ForumCategoryPeer::ID, $this->id);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getForumCategorysRelatedById() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addForumCategoryRelatedById($relObj->copy($deepCopy));
                }
            }
    ...
    public function setParentCategory(ForumCategory $v = null)
    {
        ...
        if ($v !== null) {
            $v->addForumCategoryRelatedById($this);
        }
    ...
    {
        if ($this->aParentCategory === null && ($this->parent_id !== null)) {
            $this->aParentCategory = ForumCategoryQuery::create()->findPk($this->parent_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aParentCategory->addForumCategorysRelatedById($this);
             */
        }
    ...
    {
        if ('ForumCategoryRelatedById' == $relationName) {
    ...
    /**
     * Clears out the collForumCategorysRelatedById collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return void
     * @see        addForumCategorysRelatedById()
     */
    ...
    /**
     * Initializes the collForumCategorysRelatedById collection.
     *
     * By default this just sets the collForumCategorysRelatedById collection to an empty array (like clearcollForumCategorysRelatedById());
     ...
     * @return void
     */
    public function initForumCategorysRelatedById($overrideExisting = true)
    {
        if (null !== $this->collForumCategorysRelatedById && !$overrideExisting) {
            return;
        }
        $this->collForumCategorysRelatedById = new PropelObjectCollection();
        $this->collForumCategorysRelatedById->setModel('ForumCategory');
    }

    /**
     * Gets an array of ForumCategory objects which contain a foreign key that references this object.
     *
    ...
    public function getForumCategorysRelatedById($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collForumCategorysRelatedById || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collForumCategorysRelatedById) {
                ...
                $collForumCategorysRelatedById = ForumCategoryQuery::create(null, $criteria)
        ...
        return $this->collForumCategorysRelatedById;
    }

    /**
     * Sets a collection of ForumCategoryRelatedById objects related by a one-to-many relationship
    ...
    {
        $this->forumCategorysRelatedByIdScheduledForDeletion = $this->getForumCategorysRelatedById(new Criteria(), $con)->diff($forumCategorysRelatedById);

        foreach ($this->forumCategorysRelatedByIdScheduledForDeletion as $forumCategoryRelatedByIdRemoved) {
            $forumCategoryRelatedByIdRemoved->setParentCategory(null);
        }

        $this->collForumCategorysRelatedById = null;
        foreach ($forumCategorysRelatedById as $forumCategoryRelatedById) {
            $this->addForumCategoryRelatedById($forumCategoryRelatedById);
        }
    ...
    public function countForumCategorysRelatedById(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collForumCategorysRelatedById || null !== $criteria || $partial) {
            ...
            return count($this->collForumCategorysRelatedById);
        }
    }

    /**
     * Method called to associate a ForumCategory object to this object
    ...
    /**
     * @param	ForumCategoryRelatedById $forumCategoryRelatedById The forumCategoryRelatedById object to add.
     */
    protected function doAddForumCategoryRelatedById($forumCategoryRelatedById)
    {
        $this->collForumCategorysRelatedById[]= $forumCategoryRelatedById;
        $forumCategoryRelatedById->setParentCategory($this);
    }

    /**
     * @param	ForumCategoryRelatedById $forumCategoryRelatedById The forumCategoryRelatedById object to remove.
     */
    public function removeForumCategoryRelatedById($forumCategoryRelatedById)
    {
        if ($this->getForumCategorysRelatedById()->contains($forumCategoryRelatedById)) {
            $this->collForumCategorysRelatedById->remove($this->collForumCategorysRelatedById->search($forumCategoryRelatedById));
            if (null === $this->forumCategorysRelatedByIdScheduledForDeletion) {
                $this->forumCategorysRelatedByIdScheduledForDeletion = clone $this->collForumCategorysRelatedById;
                $this->forumCategorysRelatedByIdScheduledForDeletion->clear();
            }
            $this->forumCategorysRelatedByIdScheduledForDeletion[]= $forumCategoryRelatedById;
            $forumCategoryRelatedById->setParentCategory(null);
        }
    }
    ...
    public function initForumTopics($overrideExisting = true)
    {
        ...
        $this->collForumTopics = new PropelObjectCollection();
        $this->collForumTopics->setModel('ForumTopic');
    }

    /**
     * Gets an array of ForumTopic objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
    ...
    public function getForumTopics($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collForumTopics || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collForumTopics) {
                ...
                $collForumTopics = ForumTopicQuery::create(null, $criteria)
    ...
    /**
     * Sets a collection of ForumTopic objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
    ...
    {
        $this->forumTopicsScheduledForDeletion = $this->getForumTopics(new Criteria(), $con)->diff($forumTopics);

        foreach ($this->forumTopicsScheduledForDeletion as $forumTopicRemoved) {
            $forumTopicRemoved->setCategory(null);
        }
    ...
    /**
     * Method called to associate a ForumTopic object to this object
    ...
    /**
     * @param	ForumTopic $forumTopic The forumTopic object to add.
     */
    protected function doAddForumTopic($forumTopic)
    {
    ...
    /**
     * @param	ForumTopic $forumTopic The forumTopic object to remove.
     */
    public function removeForumTopic($forumTopic)
    {
        if ($this->getForumTopics()->contains($forumTopic)) {
            $this->collForumTopics->remove($this->collForumTopics->search($forumTopic));
            ...
            $this->forumTopicsScheduledForDeletion[]= $forumTopic;
    ...
    {
        if ($deep) {
            if ($this->collForumCategorysRelatedById) {
                foreach ($this->collForumCategorysRelatedById as $o) {
        ...
        if ($this->collForumCategorysRelatedById instanceof PropelCollection) {
            $this->collForumCategorysRelatedById->clearIterator();
        }
        $this->collForumCategorysRelatedById = null;
        if ($this->collForumTopics instanceof PropelCollection) {
            $this->collForumTopics->clearIterator();
        }
        $this->collForumTopics = null;
        $this->aParentCategory = null;
    }
