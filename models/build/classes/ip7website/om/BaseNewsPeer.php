...
abstract class BaseNewsPeer {
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (self::ID, self::AUTHOR_ID, self::TITLE, self::TEXT, self::DATE, self::CURSUS_ID, self::COURSE_ID, self::ACCESS_RIGHTS, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::AUTHOR_ID => 1, self::TITLE => 2, self::TEXT => 3, self::DATE => 4, self::CURSUS_ID => 5, self::COURSE_ID => 6, self::ACCESS_RIGHTS => 7, ),
